...
closeValue.prototype = {
    ...
    execution: function() {
        if (this.flag == 0) { return this.init() } else if (this.flag == 1) { return this.update() };
    }
};
...
var textSet = [
    { text: "THIS IS", sphereRadius: 140, sphereSpace: 80, unitTime: 100, time: 1000 },
    { text: "####", sphereRadius: 100, sphereSpace: 70, unitTime: 120, time: 4000 },
    { text: "SUBGOD", sphereRadius: 120, sphereSpace: 70, unitTime: 120, time: 4000 },
    { text: "@@@@@", sphereRadius: 80, sphereSpace: 70, unitTime: 120, time: 4000 },
